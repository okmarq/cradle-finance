        ...
        <akaunting-modal
            ...
            <template #card-footer>
                <div class="flex items-center justify-end">
                    ...
                    <button :disabled="form.loading" type="button" class="relative flex items-center justify-center bg-blue-400 hover:bg-blue-700 text-white px-6 py-1.5 text-base rounded-lg disabled:bg-green-100" @click="addTemplate">
                        <x-button.loading>
