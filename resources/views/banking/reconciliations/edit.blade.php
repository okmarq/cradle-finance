                            ...
                            <div v-if="! reconcile">
                                <x-tooltip id="tooltip-reconcile" placement="top" message="{{ trans('reconciliations.irreconcilable') }}">
                                    <x-button
                                        type="button"
                                        ::disabled="! reconcile"
                                        class="relative flex items-center justify-center px-3 py-1.5 ltr:ml-2 rtl:mr-2 text-white text-base rounded-lg bg-blue-400 hover:bg-blue-700 disabled:bg-blue-100"
                                        override="class"
