<x-layouts.portal>
    ...
    <x-slot name="buttons">
        ...
        <x-link href="{{ route('portal.payments.pdf', $payment->id) }}" class="px-3 py-1.5 mb-3 sm:mb-0 bg-blue-400 hover:bg-blue-700 text-white font-medium rounded-xl text-sm leading-6">
