...
@if (! $hideNewDropdown)
    <x-dropdown id="show-new-actions-{{ $contact->type }}">
        <x-slot name="trigger" class="w-full flex items-center justify-between sm:justify-start px-3 py-1.5 mb-3 sm:mb-0 bg-blue-400 hover:bg-blue-700 rounded-xl text-white text-sm font-bold leading-6" override="class">
