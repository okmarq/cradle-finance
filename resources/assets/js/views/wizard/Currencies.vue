    ...
    <div class="relative bg-body z-10 rounded-lg shadow-2xl p-5 sm:p-10 full-height-mobile" style="height:675px;">
        ...
        <div class="flex flex-col justify-between -mt-5 sm:mt-0 overflow-y-auto" style="height: calc(100% - 53px)">
                                ...
                                <td class="w-full p-0 current-tab" v-if="current_tab == index">
                                    <div class="grid sm:grid-cols-12 gap-x-8 gap-y-6 py-3">
                                        ...
                                        <div class="flex justify-end items-center sm:col-span-12">
                                            ...
                                            <button
                                                type="submit"
                                                class="relative flex items-center justify-center bg-blue-400 hover:bg-blue-700 text-white px-6 py-1.5 text-base rounded-lg disabled:bg-green-100"
                    ...
                    <div class="flex flex-col items-center">
                        <div v-if="new_datas" class="grid sm:grid-cols-12 gap-x-8 gap-y-6 px-1 py-3.5 w-full border-b hover:bg-gray-100">
                            ...
                            <div class="flex items-center justify-end sm:col-span-12">
                                ...
                                <button type="submit" :disabled="button_loading" class="relative flex items-center justify-center bg-blue-400 hover:bg-blue-700 text-white px-6 py-1.5 text-base rounded-lg disabled:bg-green-100" @click="onSubmitForm($event)">
                        ...
                        <button v-if="! currencies.length && ! new_datas" type="button" class="relative flex items-center justify-center bg-blue-400 hover:bg-blue-700 text-white px-6 py-1.5 text-base rounded-lg disabled:bg-green-100 mt-3" @click="onAddItem()">
            ...
            <div class="flex items-center justify-center mt-5 gap-x-10">
                ...
                <base-button class="w-1/2 relative flex items-center justify-center bg-blue-400 hover:bg-blue-700 text-white px-6 py-1.5 text-base rounded-lg disabled:bg-green-100" @click="next()">
