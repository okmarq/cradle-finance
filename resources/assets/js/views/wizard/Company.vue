        ...
        <div class="flex flex-col justify-between -mt-5 sm:mt-0 overflow-y-auto" style="height: calc(100% - 53px)">
                        ...
                        <div class="flex flex-col justify-between -mt-5 sm:mt-0">
                            <div class="grid sm:grid-cols-6 gap-x-8 gap-y-6 my-3.5 menu-scroll gap-10">
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-2">
                                        <small>
                                            <a href="https://usecradleapps.com/dashboard" class="text-blue" target="_blank">Click here</a>
                                                to get your API key.
                                        </small>
                                    </div>
                                </div>
            ...
            <div class="flex items-center justify-center mt-5 gap-x-10">
                ...
                <button
                    ...
                    class="w-1/2 relative flex items-center justify-center bg-blue-400 hover:bg-blue-700 text-white px-6 py-1.5 text-base rounded-lg disabled:bg-green-100"
