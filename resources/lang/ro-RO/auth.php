...
return [
    ...
    'invitation' => [
        'message_1'         => 'Primești acest email deoarece ești invitat să te alături în Cradle Finance.',
    ...
    'information' => [
        ...
        'customize'         => 'Personalizează-ți Cradle Finance',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administrator',
            'description'   => 'Aceștia au acces deplin la Cradle Finance-ul tău, inclusiv la clienți, facturi, rapoarte, setări și aplicații.',
        ],
        'manager' => [
            'name'          => 'Manager',
            'description'   => 'Obțin acces deplin la Cradle Financeul tău, dar nu pot gestiona utilizatorii și aplicațiile.',
        ],
        'customer' => [
            'name'          => 'Client',
