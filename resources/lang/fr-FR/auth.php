...
return [
    ...
    'invitation' => [
        'message_1'         => 'Vous recevez cet e-mail parce que vous êtes invité à rejoindre Cradle Finance.',
    ...
    'information' => [
        ...
        'customize'         => 'Personnaliser votre Cradle Finance',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administrateur',
            'description'   => 'Ils obtiennent un accès complet à votre Cradle Finance, y compris vos clients, factures, rapports, paramètres et applications.',
        ],
        'manager' => [
            'name'          => 'Gérant',
            'description'   => 'Ils ont un accès complet à votre Cradle Finance, mais ne peuvent pas gérer les utilisateurs et les applications.',
        ],
        'customer' => [
            'name'          => 'Client',
