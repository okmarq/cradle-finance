...
return [
    ...
    'invitation' => [
        'message_1'         => 'You are receiving this email because you are invited to join the Cradle Finance.',
    ...
    'information' => [
        ...
        'customize'         => 'Customise your Cradle Finance',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'They get full access to your Cradle Finance including customers, invoices, reports, settings, and apps.',
        ],
        'manager' => [
            'name'          => 'Manager',
            'description'   => 'They get full access to your Cradle Finance, but can\'t manage users and apps.',
        ],
        'customer' => [
            'name'          => 'Customer',
