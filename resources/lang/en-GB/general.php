...
return [
    ...
    'empty' => [
        'documentation' => 'Check out the <a href=":url" target="_blank" class="text-blue bg-no-repeat bg-0-2 bg-0-full hover:bg-full-2 bg-gradient-to-b from-transparent to-green transition-backgroundSize">documentation</a> for more details.',
