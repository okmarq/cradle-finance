...
return [
    ...
    'invitation' => [
        'message_1'         => 'Получавате този имейл, защото сте поканени да се присъедините към Cradle Finance.',
    ...
    'information' => [
        ...
        'customize'         => 'Персонализирайте вашия Cradle Finance',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Администратор',
            'description'   => 'Те получават пълен достъп до вашия Cradle Finance, включително клиенти, фактури, отчети, настройки и приложения.',
        ],
        'manager' => [
            'name'          => 'Мениджър',
            'description'   => 'Те получават пълен достъп до вашия Cradle Finance, но не могат да управляват потребители и приложения.',
        ],
        'customer' => [
            'name'          => 'Клиент',
