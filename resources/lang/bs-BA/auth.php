...
return [
    ...
    'invitation' => [
        'message_1'         => 'Primili ste ovaj email jer ste pozvani da se pridružite Cradle Financeu.',
    ...
    'information' => [
        ...
        'customize'         => 'Prilagodite svoj Cradle Finance',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'Oni dobijaju potpuni pristup vašem Cradle Finance-u uključujući klijente, fakture, izvještaje, postavke i aplikacije.',
        ],
        'manager' => [
            'name'          => 'Upravljaj',
            'description'   => 'Oni imaju potpuni pristup vašem Cradle Financeu, ali ne mogu upravljati korisnicima i aplikacijama.',
        ],
        'customer' => [
            'name'          => 'Kupci',
