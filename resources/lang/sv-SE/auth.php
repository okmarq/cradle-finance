...
return [
    ...
    'invitation' => [
        'message_1'         => 'Du får detta e-postmeddelande eftersom du är inbjuden att gå med i Cradle Finance.',
    ...
    'information' => [
        ...
        'customize'         => 'Anpassa Cradle Finance',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administratör',
            'description'   => 'De får full tillgång till din Cradle Finance inklusive kunder, fakturor, rapporter, inställningar och appar.',
        ],
        'manager' => [
            'name'          => 'Föreståndare',
            'description'   => 'De får full tillgång till din Cradle Finance, men kan inte hantera användare och appar.',
        ],
        'customer' => [
            'name'          => 'Kund',
