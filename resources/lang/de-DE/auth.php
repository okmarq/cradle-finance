...
return [
    ...
    'invitation' => [
        'message_1'         => 'Sie erhalten diese E-Mail, weil Sie zur zusammenarbeit bei Cradle Finance eingeladen wurden.',
    ...
    'information' => [
        ...
        'customize'         => 'Passen Sie Ihr Cradle Finance an',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'Sie erhalten vollen Zugriff auf Cradle Finance, einschließlich Kunden, Rechnungen, Berichte, Einstellungen und Apps.',
        ],
        'manager' => [
            'name'          => 'Manager',
            'description'   => 'Sie erhalten vollen Zugriff auf Cradle Finance, können aber keine Benutzer und Apps verwalten.',
        ],
        'customer' => [
            'name'          => 'Kunde',
