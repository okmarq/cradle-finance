...
return [
    ...
    'invitation' => [
        'message_1'         => 'Du modtager denne e-mail, fordi du er inviteret til at deltage i Cradle Finance.',
    ...
    'information' => [
        ...
        'customize'         => 'Tilpas din Cradle Finance',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'De får fuld adgang til din Cradle Finance herunder kunder, fakturaer, rapporter, indstillinger og apps.',
        ],
        'manager' => [
            'name'          => 'Leder',
            'description'   => 'De får fuld adgang til din Cradle Finance, men kan ikke administrere brugere og apps.',
        ],
        'customer' => [
            'name'          => 'Kunde',
