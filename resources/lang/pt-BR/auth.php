...
return [
    ...
    'invitation' => [
        'message_1'         => 'Você está recebendo este e-mail porque foi convidado a juntar-se ao Cradle Finance.',
    ...
    'information' => [
        ...
        'customize'         => 'Personalize seu Cradle Finance',
    ],
    ...
    'roles' => [
        ...
        'manager' => [
            'name'          => 'Gerente',
            'description'   => 'Eles têm acesso total ao seu Cradle Finance, mas não podem gerenciar usuários e apps.',
        ],
        'customer' => [
            'name'          => 'Cliente',
