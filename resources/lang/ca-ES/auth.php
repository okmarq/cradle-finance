...
return [
    ...
    'invitation' => [
        'message_1'         => 'Estàs rebent aquest correu electrònic perquè estàs convidat a unir-te a l\'Cradle Finance.',
    ...
    'information' => [
        ...
        'customize'         => 'Personalitza el teu Cradle Finance',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administrador',
            'description'   => 'Tenen accés complet al vostre Cradle Finance, inclosos clients, factures, informes, configuracions i aplicacions.',
        ],
        'manager' => [
            'name'          => 'Gerent',
            'description'   => 'Tenen accés complet al teu Cradle Finance, però no poden gestionar usuaris i aplicacions.',
        ],
        'customer' => [
            'name'          => 'Client',
