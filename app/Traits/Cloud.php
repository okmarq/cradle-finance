...
trait Cloud
{
    ...
    public $cloud_host = 'app.usecradleapps.com';
    ...
    {
        if (! $this->isCloud()) {
            return 'https://usecradleapps.com/apps/roles?utm_source=software&utm_medium=' . $location . '&utm_campaign=roles';
        }
    ...
    {
        if (! $this->isCloud()) {
            return 'https://usecradleapps.com/apps/bank-feeds?utm_source=software&utm_medium=' . $location . '&utm_campaign=bank_feeds';
        }
